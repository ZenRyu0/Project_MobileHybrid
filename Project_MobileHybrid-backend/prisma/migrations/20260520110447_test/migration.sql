...
-- CreateTable
CREATE TABLE "DailyCalorieTarget" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "DailyCalorieTarget_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "DailyCalorieTarget_userId_key" ON "DailyCalorieTarget"("userId");
...
-- AddForeignKey
ALTER TABLE "DailyCalorieTarget" ADD CONSTRAINT "DailyCalorieTarget_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
