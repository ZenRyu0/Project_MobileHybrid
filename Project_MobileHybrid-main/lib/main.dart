...
import 'pages/logworkoutpage.dart';
import 'pages/searchpage.dart';
import 'pages/userprofileviewpage.dart';
      ...
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => CalorieProvider(
            CalorieRepository(CalorieService()),
            authRepository,
          ),
        ),
        ChangeNotifierProvider(
          create: (_) => PostProvider(PostRepository(PostService()), authRepository),
        ),
        ChangeNotifierProvider(
          create: (_) => SettingsProvider(UserRepository(UserService())),
        ),
      ],
        ...
        builder: (_, ThemeMode currentMode, __) {
          return MaterialApp(
            ...
            routes: {
              ...
              AppRoutes.logWorkout: (_) => const LogWorkoutPage(),
              ...
              if (settings.name == AppRoutes.userProfile) {
                ...
                if (userId != null) {
                  return MaterialPageRoute(
                    builder: (context) =>
                        UserProfileViewPage(userId: userId),
                  );
                }
              }
              return null;
